...
app.service('LeadStatusDetailService',
    ['$localStorage', '$http', '$q', 'urls',
        function ($localStorage, $http, $q, urls) {
            ...
            return     $http.get(urls.STATUS_DETAIL_SERVICE_API, config)
                    .then(
                        function (response) {
            ...
            function loadAllLeadStatusDetails() {
                ...
                var deferred = $q.defer();
                $http.get(urls.STATUS_DETAIL_SERVICE_API)
                    .then(
                        function (response) {
            ...
            function getLeadStatusDetail(id) {
                ...
                var deferred = $q.defer();
                $http.get(urls.STATUS_DETAIL_SERVICE_API + id)
                    .then(
                        function (response) {
            ...
            function updateLeadStatusDetail(user, id) {
                ...
                var deferred = $q.defer();
                $http.put(urls.STATUS_DETAIL_SERVICE_API + id, user)
                    .then(
                        function (response) {
                            loadAllLeadStatusDetails();
                            deferred.resolve(response.data);
            ...
            function removeLeadStatusDetail(id) {
                ...
                var deferred = $q.defer();
                $http.delete(urls.STATUS_DETAIL_SERVICE_API + id)
                    .then(
                        function (response) {
                            loadAllLeadStatusDetails();
                            deferred.resolve(response.data);
