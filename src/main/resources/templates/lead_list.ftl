  ...
  <form ng-submit="ctrl.submit()" name="myForm" class="form-horizontal">
    <div class="panel panel-default" ng-show="ctrl.display">
      ...
      <div class="panel-body">
        <div class="formcontainer">
          ...
          <div class="row">
            <div class="form-group col-sm-4">
              <label class="col-sm-5  control-label"  for="firstName" require>First Name </label>
              <div class="col-sm-7">
          ...
          <div class="row">
            ...
            <div class="form-group col-sm-4">
              <label class="col-sm-5  control-label">File</label>
              <div class="col-sm-7">
            ...
            <div class="form-group col-sm-4">
              <label class="col-sm-5  control-label" for="agentAssignment">Agent Assignment</label>
              <div class="col-sm-7">
          ...
          <div class="row col-sm-offset-1 col-sm-10" ng-show="!ctrl.lead.status.id  & ctrl.lead.status.id != 1  ">
            <div class="panel panel-default">
              ...
              <div class="panel-body">
                ...
                <div class="row">
                  ...
                  <div class="form-group col-sm-4">
                    <label class=" col-sm-4 control-lable" for="transportation">Transporation</label>
                    <div class="col-sm-7">
                  ...
                  <div class="form-group col-sm-4">
                    <label class=" col-sm-4 control-label" for="drappointment">Dr Appointment</label>
                  ...
                  <div class="form-group col-sm-4">
                    ...
                    <div class="col-sm-7">
                      <textarea name="notes" class="form-control" id="notes" ng-model="ctrl.selectedAgentLeadAppointment.notes"></textarea </div </div>
                    </div>
                  </div>
                </div>
        ...
        <div class="panel panel-default" ng-show="ctrl.display">
          ...
          <div class="panel-body">
            ...
            <div class="row">
              ...
              <div class="form-group col-sm-4">
                <label class="col-sm-5  control-label"   for="email" require>Email </label>
                <div class="col-sm-7">
        ...
        <div class="panel panel-default" ng-show="ctrl.display && agentCheck">
          <!-- Default panel contents -->
