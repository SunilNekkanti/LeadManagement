				   ...
				   <div class="form-group">
				    ...
				    <div class="form-group">
				    	<label class="control-label col-sm-4" for="gender">Gender</label>
				      	<div class="col-sm-8">
				        	<select ng-model="ctrl.lead.genderId" name="gender" class="form-control" ng-options="gender.description for gender in ctrl.genders track by gender.description" required></select>
                			<div class="has-error" ng-show="myForm.$dirty">
				    ...
				    <div class="form-group">
				    	<label class="control-label col-sm-4" for="language">Language</label>
				      	<div class="col-sm-8">
				        	<select ng-model="ctrl.lead.language" name="language" class="form-control" ng-options="language.description for language in ctrl.languages track by language.description" required></select>
                			<div class="has-error" ng-show="myForm.$dirty">
				...
				<div class="col-sm-6">
				 	<div class="form-group">
				    	<label class="control-label col-sm-4" for="planType">Plan Type</label>
				      	<div class="col-sm-8">
				        	<select ng-model="ctrl.lead.planType" class="form-control" ng-options="planType.description for planType in ctrl.planTypes track by planType.description" required></select>
                			<div class="has-error" ng-show="myForm.$dirty">
                  				<span ng-show="myForm.language.$error.required">This is a required field</span>
                			</div>
				      	</div>
				   ...
				   <div class="form-group">
				    	<label class="control-label col-sm-4" for="currentPlan">Current Plan</label>
				      	<div class="col-sm-8">
				        	<select ng-model="ctrl.lead.leadMbrInsuranceList" class="form-control" ng-options="insurance.name for insurance in ctrl.insurances | filter :{planType:{id:ctrl.lead.planType.id}} track by insurance.name"></select>
				      	</div>
				    </div>
					...
					<legend>Source</legend>
						...
						<div class="form-group">
				  			<label class="col-md-5 control-label" for="selectbasic">Status</label>
				   			<div class="col-md-9">
				    			<select ng-model="ctrl.lead.status" class="form-control" ng-options="status.description for status in ctrl.statuses track by status.description" required></select>
				  			</div>
						</div>
				
						<div class="form-group" ng-show="ctrl.loginUser.roleName != 'ROLE_AGENT'">
				  			<label class="col-md-3 control-label" for="eventName">Source1</label>
				  			<div class="col-md-3">
				  				<select ng-model="ctrl.lead.event" class="form-control" ng-options="event.eventName for event in ctrl.events track by event.eventName" required></select>
				  			</div>
						
						    <label class="col-md-3 control-label" for="status1">Source2</label>
				  			<div class="col-md-3"> 
								<select ng-model="ctrl.event.user" class="form-control" ng-options="agent.username for agent in ctrl.users  | filter:{roles:[{role:'ROLE_AGENT'}]} track by agent.username" required></select>
							</div>
						</div>
				
						<div class="form-group" ng-show="!ctrl.lead.status.id  & ctrl.lead.status.id != 1  ">
							<label class="col-md-3 control-label" for="uname">PCP </label>
					  		<div class="col-md-3">
					  		...
					  		<label class="col-md-3 control-label" for="plan">Plan</label>
					  		<div class="col-md-3">
					  			<select class="col-sm-7 form-control" ng-model="ctrl.selectedAgentLeadAppointment.planType" ng-options="planType.description for planType in ctrl.planTypes track by planType.description" required="ctrl.lead.status.id == 2"></select>
					  		</div>
						</div>
				
						<div class="form-group" ng-show="!ctrl.lead.status.id  & ctrl.lead.status.id != 1  ">
							<label class="col-md-3 control-label" for="effectiveDate">Effective From</label>
					  		<div class="input-group date col-md-3" id="besttime" ng-model="ctrl.selectedAgentLeadAppointment.effectiveFrom" date-picker>
					  		...
					  		<label class="col-md-3 control-label" for="transportation">Transportation</label>
					  		<div class="col-md-3">
						...
						<div class="form-group" ng-show="!ctrl.lead.status.id  & ctrl.lead.status.id != 1  ">
					  		...
					  		<label class="col-md-3 control-label" for="drappointment">Dr Appointment </label>
					  		<div  class="input-group date col-md-3" name="drappointment" ng-model="ctrl.selectedAgentLeadAppointment.drappointment" date-picker>
					...
					<div class="col-sm-6">
						<div class="form-group">
					 		<label class="col-sm-4  control-label" for="agent">Agent</label>
					      	<div class="col-sm-8">
					        	<select ng-model="ctrl.selectedAgentLeadAppointment.user" class="form-control" ng-options="agent.username for agent in ctrl.users  | filter:{roles:[{role:'ROLE_AGENT'}]} track by agent.username" required></select>
					      	</div>
					     </div> 	
