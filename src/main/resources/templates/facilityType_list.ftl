<div class="generic-container">
   <div class="panel panel-default" ng-if="!ctrl.display">
        ...
        <div class="panel-heading"><span class="facilityType">List of Facility Types </span> 
               ...
               <button type="button" ng-click="ctrl.editFacilityType(ctrl.facilityTypeId)" ng-show="ctrl.displayEditButton" class="btn btn-primary btn-xs  custom-width floatRight">Edit</button>  
              <button type="button" ng-click="ctrl.removeFacilityType(ctrl.facilityTypeId)"  ng-show="ctrl.displayEditButton" class="btn btn-danger btn-xs  custom-width floatRight">Remove</button>  
        </div>
	            ...
	            <form ng-submit="ctrl.submit()" name="myForm" class="form-horizontal">
	                ...
	                <div class="row">
	                    <div class="form-actions floatCenter col-md-offset-8">
	                        <input type="submit"  value="{{!ctrl.facilityType.id ? 'Add' : 'Update'}}" class="btn btn-primary btn-xs" ng-disabled="myForm.$invalid || myForm.$pristine">
	                        <button type="button" ng-click="ctrl.reset()" class="btn btn-warning btn-xs" ng-show="!ctrl.facilityType.id" ng-disabled="myForm.$pristine">Reset Form</button>
	                        <button type="button" ng-click="ctrl.cancelEdit()" class="btn btn-warning btn-xs" ng-show="ctrl.facilityType.id" >Cancel</button>
	                    </div>
	                </div>
	            </form>
    	    </div>
