...
<div class="generic-container">
   <div class="panel panel-default" ng-if="!ctrl.display">
        ...
        <div class="panel-heading"><span class="role">List of Roles </span> 
               ...
               <button type="button" ng-click="ctrl.editRole(ctrl.facilityTypeId)" ng-show="ctrl.displayEditButton" class="btn btn-primary btn-xs  custom-width floatRight">Edit</button>  
              <button type="button" ng-click="ctrl.removeRole(ctrl.facilityTypeId)"  ng-show="ctrl.displayEditButton" class="btn btn-danger  btn-xs custom-width floatRight">Remove</button>  
        </div>
